...
//----< return children of doc element >-----------------------------
...
//----< get children of Tagged element >-------------------------------
std::vector<std::shared_ptr<AbstractXmlElement>> TaggedElement::getChildren()
{
	return children_;
}

//----< get attributes of Tagged element >-------------------------------
std::vector<std::pair<std::string, std::string>> TaggedElement::getAttributes()
{
	return attribs_;
}
...
//----< getAttributes of ProcInstrElement >-------------------------------
std::vector<std::pair<std::string, std::string>> ProcInstrElement::getAttributes()
{
	return attribs_;
}

//----< generate xml string for del element >-------------------------------
...
//----< getAttributes of XmlDeclarElement >-------------------------------
std::vector<std::pair<std::string, std::string>> XmlDeclarElement::getAttributes()
{
	return attribs_;
}
...
//----< generate xml string for xml comment element >-------------------------------
