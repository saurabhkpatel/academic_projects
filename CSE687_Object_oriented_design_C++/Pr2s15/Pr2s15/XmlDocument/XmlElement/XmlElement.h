...
*     add child to xml element. Derived class will implement this method.
* virtual bool removeChild(std::shared_ptr<AbstractXmlElement> pChild);
*     remove child from xml element. Derived class will implement this method.
* virtual bool addAttrib(const std::string& name, const std::string& value);
*     add attribute in xml element. Derived class will implement this method.
* virtual bool removeAttrib(const std::string& name);
*     remove attribute from xml element. Derived class will implement this method.
* virtual std::vector<std::shared_ptr<AbstractXmlElement>> getChildren();
*     getChildren of from xml element. Derived class will implement this method.
* virtual std::vector<std::pair<std::string, std::string>> getAttributes();
*     getAttributes of from xml element. Derived class will implement this method.
* virtual std::string value() = 0;
*     pure virtual method, every derived class sure implement this.
...
* --------------------
* ver 1.6 : 21 Mar 15
* - added some functions to support get childrean and attributes from xml elements.
* ver 1.5 : 22 Feb 15
