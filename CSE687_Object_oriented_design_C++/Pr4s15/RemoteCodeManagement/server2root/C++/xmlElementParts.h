...
/*
  ...
  ====================
  ver 1.4 : 28 Jan 13
  - fixed warning by changing int to size_t in toLower and find
  ver 1.3 : 31 Jan 09
...
public:
  ...
  virtual bool merge(const std::string& firstTok, const std::string& secondTok) { return false; }
  virtual bool remove(const std::string& tok);
  virtual bool remove(size_t i) { return false; }
...
inline size_t XmlParts::length() { return (int)toks.size(); }
