...
/////////////////////////////////////////////////////////////////////////////
// Server2.h - Send file to server and receive ACK from server             //
//																		   //
// ----------------------------------------------------------------------- //
...
* Required Files:
* ============================
* Server2.h, Server2.cpp, HttpMessage.cpp , HttpMessage.h
...
{
public:
	Server2(std::string address = "localhost", int port = 9086) : address_(address), port_(port), server2Receiver(queue, "./server2root/") {}
